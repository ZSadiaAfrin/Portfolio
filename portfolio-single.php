...
$after_assoc = mysqli_fetch_assoc($select_work_res);
                        ...
                        <div class="col-xl-9 col-lg-10">
                            <div class="single-blog-list">
                                <div class="blog-list-thumb mb-35">
                                    <img src="uploads/work/feat/<?=$after_assoc['feat_image']?>" alt="img">
                                </div>
                                    ...
                                    <div class="blog-list-meta">
                                        <ul>
                                            ...
                                            <li class="blog-post-share">
                                                ...
                                                <a href="http://www.twitter.com/share?url=portfolio-single.php?id=<?=$id?>"><i class="fab fa-twitter"></i></a>
                                                <a href="https://plus.google.com/share?url=portfolio-single.php?id=<?=$id?>"><i class="fab fa-google"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                        ...
                                        <li>
                                            <div class="post-avatar-img">
                                                <?php if ($after_assoc_user['photo']==null) {?>
                                                   ...
                                                   <?php } else{?>
                                                    <img width="100" height="100" src="uploads/user/<?=$after_assoc_user['photo']?>" alt="img">
                                                <?php } ?>
                                            </div>
