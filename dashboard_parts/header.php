<?php
   ...
   $select1="SELECT * FROM messages WHERE status=0";
   $select_res2=mysqli_query($db_connection,$select1);
   

   //for messages count
    $select_message = "SELECT COUNT(*) as total FROM messages WHERE status=0";
    $select_message_res=mysqli_query($db_connection,$select_message);
    $after_assoc_message=mysqli_fetch_assoc($select_message_res);
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                <img class="logo-abbr" src="/raze/dashboard_asset/images/logo.png" alt="">
                <img class="logo-compact" src="/raze/dashboard_asset/images/logo-text.png" alt="">
                <img class="brand-title" src="/raze/dashboard_asset/images/logo-text.png" alt="">
            </a>
                                ...
                                <div class="dropdown-menu rounded dropdown-menu-right">
                                    <div id="DZ_W_Notification1" class="widget-media dz-scroll p-3 height380">
										<ul class="timeline">
                                                ...
                                                foreach ($select_res2 as $new)
                                                
                                                { ?> 
                                                    <a href="../raze/message/message_view.php?id=<?=$new['id']?>">
                                                    <li>
                                                        <div class="timeline-panel">
                                                            <div class="media mr-2">
                                                                <img alt="image" width="50" src="../raze/dashboard_asset/images/avatar/1.jpg">
                                                            </div>
                                                            <div class="media-body">
                                                                <h6 class="mb-1"><?=$new['name']?> Send you Photo</h6>
                                                                <small class="d-block"><?=$new['date']?></small>
                                                            </div>
                                                        </div>
                                                    </li>
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    <?php if($after_assoc['photo'] == null) { ?>
                                        <img src="/raze/dashboard_asset/images/profile/17.jpg" width="20" alt=""/>

                                    <?php } else{ ?>
                                        <img src="/raze/uploads/user/<?=$after_assoc['photo']?>" width="20" alt=""/>
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="/raze/user/profile.php" class="dropdown-item ai-icon">
                                    ...
                                    <a href="/raze/logout.php" class="dropdown-item ai-icon">
        ...
        <div class="deznav">
            <div class="deznav-scroll">
                <ul class="metismenu" id="menu">
                    <li><a class="has-arrow ai-icon" href="/raze/dashboard.php">
                            <!-- java link repalace to dashboard link  href=javascript:void() aria-expanded="false"    -->
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/raze/user/users.php">User List</a></li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/raze/logo/add_logo.php">Add logo</a></li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/raze/banner/edit_banner.php">Edit Banner Info</a></li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/raze/social/social.php">Social Icons</a></li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/raze/skill/skill.php">Add Skills</a></li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/raze/message/message.php">See Messages </a></li>

                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="/raze/information/information.php" aria-expanded="false">
                            <i class="flaticon-381-television"></i>
                            <span class="nav-text">Information</span>
                        </a>
                    </li>
                    <li><a class="has-arrow ai-icon" href="/raze/info_social/info_social.php" aria-expanded="false">
                            <i class="flaticon-381-television"></i>
                            <span class="nav-text">Information of social</span>
                        </a>
                    </li>
                    <li><a class="has-arrow ai-icon" href="/raze/contact/contact.php" aria-expanded="false">
                            <i class="flaticon-381-television"></i>
                            <span class="nav-text">Contact</span>
                        </a>
                    </li>
                    <li><a class="has-arrow ai-icon" href="/raze/images/image.php" aria-expanded="false">
                            <i class="flaticon-381-television"></i>
                            <span class="nav-text">New Image</span>
                        </a>
                    </li>
                    <li><a class="has-arrow ai-icon" href="/raze/testimonial/testimonial.php" aria-expanded="false">
                            <i class="flaticon-381-television"></i>
                            <span class="nav-text">Testimonial</span>
                        </a>
                    </li>
                    <li><a class="has-arrow ai-icon" href="/raze/service/service.php" aria-expanded="false">
                            <i class="flaticon-381-television"></i>
                            <span class="nav-text">Service</span>
                        </a>
                    </li>
                    <li><a class="has-arrow ai-icon" href="/raze/counter/counter.php" aria-expanded="false">
                            <i class="flaticon-381-television"></i>
                            <span class="nav-text">Counter</span>
                        </a>
                    </li>
                    <li><a class="has-arrow ai-icon" href="/raze/menu/menu.php" aria-expanded="false">
                            <i class="flaticon-381-television"></i>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/raze/works/work.php">Add Works </a></li>
